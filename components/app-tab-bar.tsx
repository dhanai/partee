        ...
        {tabs.map(({ href, label, Icon, match }) => {
          ...
          return (
            <Link
              key={href}
              href={href as never}
              className="flex min-w-0 flex-1 flex-col items-center justify-end gap-0.5 rounded-lg pb-1.5 pt-1 text-[11px] font-semibold transition-colors active:opacity-80"
